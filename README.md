...
Personal collection of reusable LLM system prompts ("skills") and a running report card of model behavior, used across tools like Claude Code and Cherry Studio.
...
- When trying a model and forming an opinion of it, log the observation in `LLM_REPORT_CARD.md` under the right provider/model/aspect.
