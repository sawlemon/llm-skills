...
| Speed / latency | - very slow to respond, noticeably slower than GLM 5.2; responses often take a long time |
...
| Refusals / safety behavior | |
| Formatting / output quality | - often emits multiple long paragraphs that need reading and filtering, rather than concise task-focused output |
...
| Refusals / safety behavior | |
| Formatting / output quality | + accurate and concise in practice, without much unneeded text |
